...
<body>
  <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
    <a class="navbar-brand" href="#"><i class="fas fa-user-md"></i> BookCover</a>
  ...
  <footer class="container">
    <div class="d-flex justify-content-between">
      <div class="p-2">Studio Archistico &copy; 2017-<?= ($ANNO) ?></div>
      <div class="p-2"></div>
      <div class="p-2 font-italic">v<?= ($APP_VERSIONE) ?></div>
    </div>
  </footer>
